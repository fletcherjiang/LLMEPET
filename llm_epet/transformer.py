...
class Transformer(nn.Module):
    def __init__(self, first_layer, n_layers, d_model=512, nhead=8, num_queries=2, num_encoder_layers=6,
        ...
        dim = 4096
        llama_default_config = {"dim": dim, "multiple_of": 256,
                                "n_heads": 32, "n_layers": n_layers, "norm_eps": 1.0e-6,
                                "vocab_size": -1, "first_layer": first_layer}
    ...
    def forward(self, src, mask, query_embed, pos_embed, video_length=None, moment_idx=None, msrc=None, mpos=None, mmask=None,
        ...
        memory_trans = self.encoder(src, src_key_padding_mask=mask, pos=pos_embed)  # (L, batch_size, d)
